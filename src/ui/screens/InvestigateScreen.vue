...
/** The source preview's verdict, read trigger, Reload and Open in Obsidian (IN7-IN13). */
const { verdict, notePath, opening, openFailed, reloadPreview, openInObsidian } = useInvestigationPreview({ row: selectedRow, model });
