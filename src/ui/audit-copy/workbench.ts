...
export const WORKBENCH_CARD_TOTAL_CAPTION = 'Saved for this codebase';
...
export const PLAN_MD_NOTE = 'Saved in the plugin’s review state for this codebase. Statuses record the plan; no source code was changed.';
