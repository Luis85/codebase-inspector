...
**94 files, 1003 tests, 1002 passed,
1 skipped.**
...
| Component (jsdom) | `tests/component/**` | 30 | yes | 303 | against **our** controls: the file list, search, inspector, camera controls, viewport, status surfaces, announcements, both modals, the settings tab, the renderer contract and disposal, and (task 5) the toolbar's Scan control |
