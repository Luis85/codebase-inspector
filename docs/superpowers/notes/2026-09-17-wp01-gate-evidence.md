...
**109 files, 1074 tests, 1073 passed,
1 skipped.**
...
|---|---|---|---|---|---|
| Unit | `tests/unit/**` | 46 | yes | 504 | domain, application, UI stores, interaction state, stylesheet-as-contract (comments stripped — see below), and this table's own guard |
