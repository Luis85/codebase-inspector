...
// Shared setup: investigate-create-support.ts (split out at the 450-line cap, mirroring
// investigate-refresh-support.ts) — a refusal that lands after the dialog closed is
// investigate-create-review.test.ts's own file.
...
import {
  confirm, dialogText, frontmatterOf, liveText, openButtons, openDialog, setup, writes,
} from './investigate-create-support';
